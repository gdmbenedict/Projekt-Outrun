...
func _process(delta: float) -> void:
	...
	speedometerNeedle.rotation_degrees = -10 + (GameManager.playerMovement.GetSpeed()/GameManager.playerMovement.GetMaxSpeed())*278 #278 is degrees between max and min speeds
